...
import onight.tfw.cass.exception.KeyspaceCreateException;
import onight.tfw.cass.mapping.KeyspaceStatement;
...
public class CassandraClusterFactory {
	...
	public void initCluster(PropHelper prop) {
...

		{
			...
			options.setMaxRequestsPerConnection(HostDistance.LOCAL, prop.get("ofw.cass.pool.conn.maxreq", 15));
			...
			options.setMaxRequestsPerConnection(HostDistance.LOCAL, prop.get("ofw.cass.pool.conn.remote.maxreq", 10));
