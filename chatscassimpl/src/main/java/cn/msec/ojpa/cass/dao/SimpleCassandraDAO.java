...
import cn.msec.ojpa.api.KVExample;
import cn.msec.ojpa.api.OJpaDAO;
import cn.msec.ojpa.api.TransactionExecutor;
import cn.msec.ojpa.api.exception.JPAException;
import cn.msec.ojpa.api.exception.NotSuportException;
...
import cn.msec.ojpa.cass.util.RowMapper;
...
//		this.dao=dao;
	...
	@Override
	public Object increAnGetInt(CounterCriteria<?> counterCri) throws JPAException {
		throw new NotSuportException("increAnGetInt");
	}

	@Override
	public Object checkAndIncr(CounterCriteria<?> counterCri) throws JPAException {
		throw new NotSuportException("checkAndIncr");
	}
