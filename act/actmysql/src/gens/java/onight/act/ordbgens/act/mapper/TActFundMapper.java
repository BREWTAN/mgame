...
public interface TActFundMapper extends StaticTableDaoSupport<TActFund, TActFundExample, TActFundKey> {
    ...
    @Insert({
        ...
        "ACT_TYPE, MNY_SMB, ",
        "CATALOG, CUR_BAL, ",
        "FREEZE_TOTAL, INCOME_TOTAL, ",
        "PAYOUT_TOTAL, FOTBID_AMOUNT, ",
        "FOTBID_FLAG, ACT_STAT, ",
        "ACT_BAL_WARN_FLAG, UPDATE_ACT_LOG_ID)",
        ...
        "#{catalog,jdbcType=VARCHAR}, #{curBal,jdbcType=DECIMAL}, ",
        "#{freezeTotal,jdbcType=DECIMAL}, #{incomeTotal,jdbcType=DECIMAL}, ",
        "#{payoutTotal,jdbcType=DECIMAL}, #{fotbidAmount,jdbcType=DECIMAL}, ",
        "#{fotbidFlag,jdbcType=CHAR}, #{actStat,jdbcType=VARCHAR}, ",
        "#{actBalWarnFlag,jdbcType=VARCHAR}, #{updateActLogId,jdbcType=VARCHAR})"
    })
    ...
    @Select({
        "select",
        "FUND_NO, ACT_NO, CUST_ID, MCHNT_ID, ACT_TYPE, MNY_SMB, CATALOG, CUR_BAL, FREEZE_TOTAL, ",
        "INCOME_TOTAL, PAYOUT_TOTAL, FOTBID_AMOUNT, FOTBID_FLAG, ACT_STAT, ACT_BAL_WARN_FLAG, ",
        "UPDATE_ACT_LOG_ID",
        "from T_ACT_FUND",
        "where FUND_NO = #{fundNo,jdbcType=VARCHAR}"
    })
