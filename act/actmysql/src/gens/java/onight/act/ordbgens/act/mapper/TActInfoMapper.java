...
public interface TActInfoMapper extends StaticTableDaoSupport<TActInfo, TActInfoExample, TActInfoKey> {
    ...
    @Insert({
        ...
        "CUST_ID, MCHNT_ID, ",
        "ACT_TYPE, MNY_SMB, ",
        "CATALOG, ACT_YINIT_BAL, ",
        "ACT_DINIT_BAL, ACT_CUR_BAL, ",
        "ACT_STAT, ACT_MAXOD_AMT, ",
        "ACT_CTRL_BAL, ACT_BAL_WARN_FLAG, ",
        ...
        "#{catalog,jdbcType=VARCHAR}, #{actYinitBal,jdbcType=DECIMAL}, ",
        "#{actDinitBal,jdbcType=DECIMAL}, #{actCurBal,jdbcType=DECIMAL}, ",
        "#{actStat,jdbcType=DECIMAL}, #{actMaxodAmt,jdbcType=DECIMAL}, ",
        "#{actCtrlBal,jdbcType=DECIMAL}, #{actBalWarnFlag,jdbcType=VARCHAR}, ",
        "#{createTime,jdbcType=TIMESTAMP}, #{updateTime,jdbcType=TIMESTAMP}, ",
        "#{modifyId,jdbcType=VARCHAR}, #{memo,jdbcType=VARCHAR})"
    })
    ...
    @Select({
        "select",
        "ACT_NO, ACT_NAME, CUST_ID, MCHNT_ID, ACT_TYPE, MNY_SMB, CATALOG, ACT_YINIT_BAL, ",
        "ACT_DINIT_BAL, ACT_CUR_BAL, ACT_STAT, ACT_MAXOD_AMT, ACT_CTRL_BAL, ACT_BAL_WARN_FLAG, ",
        "CREATE_TIME, UPDATE_TIME, MODIFY_ID, MEMO",
        "from T_ACT_INFO",
        "where ACT_NO = #{actNo,jdbcType=VARCHAR}"
    })
    @Results({
