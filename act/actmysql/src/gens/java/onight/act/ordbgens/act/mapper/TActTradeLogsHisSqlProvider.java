...
import onight.act.ordbgens.act.entity.TActTradeLogsHisExample.Criterion;
import onight.act.ordbgens.act.entity.TActTradeLogsHisExample;

public class TActTradeLogsHisSqlProvider {
     ...
     */
    public String countByExample(TActTradeLogsHisExample example) {
        BEGIN();
        SELECT("count(*)");
     ...
     * @mbggenerated Mon Dec 07 11:37:59 CST 2015
     */
    public String deleteByExample(TActTradeLogsHisExample example) {
        BEGIN();
        DELETE_FROM("T_ACT_TRADE_LOGS_HIS");
        applyWhere(example, false);
        return SQL();
    }
     ...
     * @mbggenerated Mon Dec 07 11:37:59 CST 2015
     */
    public String insertSelective(TActTradeLogsHis record) {
        BEGIN();
        INSERT_INTO("T_ACT_TRADE_LOGS_HIS");
     ...
     * @mbggenerated Mon Dec 07 11:37:59 CST 2015
     */
    public String selectByExample(TActTradeLogsHisExample example) {
        BEGIN();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        TActTradeLogsHis record = (TActTradeLogsHis) parameter.get("record");
        TActTradeLogsHisExample example = (TActTradeLogsHisExample) parameter.get("example");
     ...
     * @mbggenerated Mon Dec 07 11:37:59 CST 2015
     */
    public String updateByPrimaryKeySelective(TActTradeLogsHis record) {
        BEGIN();
        UPDATE("T_ACT_TRADE_LOGS_HIS");
     ...
     * @mbggenerated Mon Dec 07 11:37:59 CST 2015
     */
    protected void applyWhere(TActTradeLogsHisExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
