...
import onight.act.ordbgens.act.entity.TActTradeLogsExample.Criterion;
import onight.act.ordbgens.act.entity.TActTradeLogsExample;

public class TActTradeLogsSqlProvider {
     ...
     */
    public String countByExample(TActTradeLogsExample example) {
        BEGIN();
        SELECT("count(*)");
     ...
     * @mbggenerated Mon Dec 07 11:37:59 CST 2015
     */
    public String deleteByExample(TActTradeLogsExample example) {
        BEGIN();
        DELETE_FROM("T_ACT_TRADE_LOGS");
        applyWhere(example, false);
        return SQL();
    }
     ...
     * @mbggenerated Mon Dec 07 11:37:59 CST 2015
     */
    public String insertSelective(TActTradeLogs record) {
        BEGIN();
        INSERT_INTO("T_ACT_TRADE_LOGS");
     ...
     * @mbggenerated Mon Dec 07 11:37:59 CST 2015
     */
    public String selectByExample(TActTradeLogsExample example) {
        BEGIN();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        TActTradeLogs record = (TActTradeLogs) parameter.get("record");
        TActTradeLogsExample example = (TActTradeLogsExample) parameter.get("example");
     ...
     * @mbggenerated Mon Dec 07 11:37:59 CST 2015
     */
    public String updateByPrimaryKeySelective(TActTradeLogs record) {
        BEGIN();
        UPDATE("T_ACT_TRADE_LOGS");
     ...
     * @mbggenerated Mon Dec 07 11:37:59 CST 2015
     */
    protected void applyWhere(TActTradeLogsExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
