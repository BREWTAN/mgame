    ...
    render:() ->
        ...
        titlenode=(
                <div id="usertitle" className="row col-md-12">
                    <div className="col-md-6"><span>您好,</span> <span>{@state.username}</span>&nbsp;&nbsp;&nbsp;<FontAwesome name='jpy' className='fa-lg ' /><span className="money">  121,213,139元</span>
                    <IconButton iconStyle={styles.iconButtonStyle} onTouchTap={@handleRefreshUserTitle} iconClassName='fa fa-refresh fa-fw' />
                    </div>
                    <div className="col-md-6">|<FlatButton style={styles.btn} labelStyle={styles.title} label="充值"/>|<FlatButton style={styles.btn} labelStyle={styles.title} label="提现" />
