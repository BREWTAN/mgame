...
public class IF_项目详情查询 {
	...
	public static class Detail {
		 ...
		 @PBFields(name = ",所属行业,String,不校验,是,")
				String industry;//  ,所属行业,String,不校验,是,
		 @PBFields(name = ",所属行业-名称,String,不校验,是,")
