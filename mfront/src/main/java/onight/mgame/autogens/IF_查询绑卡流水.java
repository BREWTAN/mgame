...
public class IF_查询绑卡流水 {
	...
	public static class PageInfo {
		 ...
		 @PBFields(name = ",绑定流水列表,List,不校验,是,")
PageInfo pageInfo;// 
	...
	public static class TcBindingBankInfoList {
		 ...
		 @PBFields(name = ",内外签约标志,String,不校验,是,")
		 ...
		 @PBFields(name = ",流水号,String,不校验,是,")
				String bizNo;//  ,流水号,String,不校验,是,
		 @PBFields(name = ",统计错误率用到,String,不校验,是,")
				String cExit;//  ,统计错误率用到,String,不校验,是,
		 @PBFields(name = ",更新错误类型,String,不校验,是,")
				String cFailTyp;//  ,更新错误类型,String,不校验,是,
		 @PBFields(name = ",终端类型,String,不校验,是,")
