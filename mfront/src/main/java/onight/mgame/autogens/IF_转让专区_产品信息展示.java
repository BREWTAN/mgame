...
// 转让专区-产品信息展示,产品相关,PrdTransferQueryController,POST,JSON,/ife/prdtransferquery/prdDeliveryInfoDetail.html@onight.mgame.utils.PBInfo(name = "PBIFE_prdtransferquery_prdDeliveryInfoDetail", path = "/ife/prdtransferquery/prdDeliveryInfoDetail.html") 
public class IF_转让专区_产品信息展示 {
	// =======REQuest==============
	...
	public static class Response {
		...
		String actualRate;//  ,实际利率,String,不校验,是,
		 @PBFields(name = ",相差天数,String,不校验,是,")
		String diffDays;//  ,相差天数,String,不校验,是,
		 @PBFields(name = ",委托金额,String,不校验,是,")
		String delegateAmount;//  ,委托金额,String,不校验,是,
		 @PBFields(name = ",委托数量,String,不校验,是,")
		String delegateNum;//  ,委托数量,String,不校验,是,
		 @PBFields(name = ",可够数量,String,不校验,是,")
		String canBuyNum;//  ,可够数量,String,不校验,是,
	@Data
	@AllArgsConstructor
	@NoArgsConstructor
	public static class TaProductFinanceDetail {
		 ...
		 @PBFields(name = ",转让是否支持浮动利率-名称,String,不校验,是,")
		 ...
		 @PBFields(name = ",发行率,String,不校验,是,")
				String buyRate;//  ,发行率,String,不校验,是,
		 @PBFields(name = ",保管费,String,不校验,是,")
		 ...
		 @PBFields(name = ",最少持有天數,String,不校验,是,")
		 ...
		 @PBFields(name = ",募集开始时间与今天的关系,String,不校验,是,")
				String comToday;//  ,募集开始时间与今天的关系,String,不校验,是,
		 @PBFields(name = ",认购总人数,String,不校验,是,")
				String totalPerson;//  ,认购总人数,String,不校验,是,
		 @PBFields(name = ",认购总金额,String,不校验,是,")
				String totalMoney;//  ,认购总金额,String,不校验,是,
		 @PBFields(name = ",当日承诺回购价格,String,不校验,是,")
				String dayRate;//  ,当日承诺回购价格,String,不校验,是,
		 @PBFields(name = ",当日承诺回购余额,String,不校验,是,")
				String dayAmount;//  ,当日承诺回购余额,String,不校验,是,
		 @PBFields(name = ",年度天数,String,不校验,是,")
				String yearDay;//  ,年度天数,String,不校验,是,
		 @PBFields(name = ",年度天数-名称,String,不校验,是,")
				String yearDayName;//  ,年度天数-名称,String,不校验,是,
		 @PBFields(name = ",付息周期,String,不校验,是,")
				String irstCycle;//  ,付息周期,String,不校验,是,
		 @PBFields(name = ",最高认购份额,String,不校验,是,")
		 ...
		 @PBFields(name = ",交易最低持有时间,String,不校验,是,")
				String tradeLeastHoldDay;//  ,交易最低持有时间,String,不校验,是,
		 @PBFields(name = ",最低转让份额,String,不校验,是,")
