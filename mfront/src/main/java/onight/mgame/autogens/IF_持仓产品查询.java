...
// 持仓产品查询,产品相关,PrdQueryController,POST,JSON,/ife/prdquery/prdQueryPositionList.html@onight.mgame.utils.PBInfo(name = "PBIFE_prdquery_prdQueryPositionList", path = "/ife/prdquery/prdQueryPositionList.html") 
public class IF_持仓产品查询 {
	// =======REQuest==============
	...
	public static class Response {
		 @PBFields(name = ",当前日期,String,不校验,否,")
		String currDateZh;//  ,当前日期,String,不校验,否,
		 @PBFields(name = ",当前时间,String,不校验,否,")
		String currDateTime;//  ,当前时间,String,不校验,否,
		 @PBFields(name = ",查询者,String,不校验,否,")
		String currUsername;//  ,查询者,String,不校验,否,
	@Data
	@AllArgsConstructor
	@NoArgsConstructor
