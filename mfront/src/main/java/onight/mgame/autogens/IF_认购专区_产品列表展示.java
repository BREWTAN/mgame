...
// 认购专区-产品列表展示,产品相关,PrdSubscribeQueryController,POST,JSON,/ife/prdsubscribequery/prdQuerySubscribeProductList.html@onight.mgame.utils.PBInfo(name = "PBIFE_prdsubscribequery_prdQuerySubscribeProductList", path = "/ife/prdsubscribequery/prdQuerySubscribeProductList.html") 
public class IF_认购专区_产品列表展示 {
	// =======REQuest==============
	...
	public static class PageInfo {
		 ...
		 @PBFields(name = ",产品列表,List,不校验,是,")
PageInfo pageInfo;// 
 
	@Data
	@AllArgsConstructor
	@NoArgsConstructor
	public static class ProductFinanceDetailList {
