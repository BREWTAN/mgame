...
// 获取单个产品详细信息和扩展信息,产品相关(非登录模式),PrdQueryController,POST,JSON,/ife/prdquery/prdQueryProductDetails.html
@onight.mgame.utils.PBInfo(name = "PBIFE_prdquery_prdQueryProductDetailsNoLogon", path = "/ife/prdquery/prdQueryProductDetailsNoLogon.html")
public class IF_获取单个产品详细信息和扩展信息_非登录模式_ {
	// =======REQuest==============
